...
var author$project$Main$Model = F3(
	function (count, firstName, lastName) {
		return {n: count, G: firstName, au: lastName};
	});
var author$project$Main$init = A3(author$project$Main$Model, 0, 'firstname', 'lastname');
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{at: author$project$Main$init, aC: author$project$Main$update, aE: author$project$Main$view});
